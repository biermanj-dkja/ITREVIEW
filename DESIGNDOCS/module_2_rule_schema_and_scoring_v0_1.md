...
This document was generated by reading the source code and writing down what it does. It is the
authoritative reference for Module 2 findings logic and scoring. Where a design intent differs
from current behaviour, it is flagged with a ⚠ gap note.
